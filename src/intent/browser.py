...
def execute(
    ...
    if mode == "open_url":
        ...
        if not url:
            return {
                "reply": "I need a URL to open.",
                "config_changed": False,
                "ok": False,
                "error_kind": "browser_url_missing",
            }
        _open_visible(url)
    ...
    if mode == "search_youtube":
        ...
        if not query:
            return {
                "reply": "I need a YouTube search query.",
                "config_changed": False,
                "ok": False,
                "error_kind": "browser_query_missing",
            }
    ...
    if mode == "search_web":
        ...
        if not query:
            return {
                "reply": "I need a web search query.",
                "config_changed": False,
                "ok": False,
                "error_kind": "browser_query_missing",
            }
