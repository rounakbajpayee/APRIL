...
def execute(node: str, command: str, config: dict[str, Any], timeout: int = 20) -> dict[str, Any]:
    global _active_node
...
def _execute_remote(node: str, command: str, config: dict[str, Any], timeout: int) -> dict[str, Any]:
    try:
        import paramiko
    except ImportError:
        return {
